...
class Product(models.Model):
    ...
    subcategory = models.ForeignKey(Subcategory, blank=True, null=True, on_delete=models.SET_NULL, related_name="products")
    ...
    def save(self, *args, **kwargs):
        # Automatically generate a slug if it is not already set
        if not self.slug:
